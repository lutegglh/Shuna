...
def update_all_messages():
    ...
    msg += f"<b>🖥️ CPU:</b> <b>{psutil.cpu_percent()}%</b> |" \
           f" <b>💾 RAM:</b> <b>{psutil.virtual_memory().percent}%</b>"
    with download_dict_lock:
        ...
        msg += f"\n<b>💿 FREE:</b> <b>{free}</b> | <b>☕ UPTIME:</b> <b>{currentTime}</b>\n<b>🔻 DL:</b> <b>{dlspeed}/s</b> | <b>🔺 UL:</b> <b>{ulspeed}/s</b>\n"
    with status_reply_dict_lock:
...
def sendStatusMessage(msg, bot):
    ...
    progress += f"<b>🖥️ CPU:</b> <b>{psutil.cpu_percent()}%</b>" \
           f" <b>💾 RAM:</b> <b>{psutil.virtual_memory().percent}%</b>"
    with download_dict_lock:
        dlspeed_bytes = 0
        uldl_bytes = 0
        ...
        dlspeed = get_readable_file_size(dlspeed_bytes)
        ulspeed = get_readable_file_size(uldl_bytes)
        progress += f"<b>💿 FREE:</b> <b>{free}</b>\n<b>☕ UPTIME:</b> <b>{currentTime}</b>\n<b>🔻DL:</b> <b>{dlspeed}/s</b> | <b>🔺UL:</b> <b>{ulspeed}/s</b>\n"
    with status_reply_dict_lock:
