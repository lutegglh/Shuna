...
def _watch(bot: Bot, update, isTar=False, isZip=False, isLeech=False):
    ...
    try:
        ...
        msg += f"\n\nContoh:\n<code>/{BotCommands.WatchCommand} https://youtu.be/blablablabla 720 |Eru</code>\n\n"
        msg += "Maka file tersebut akan dimirror di Resolusi 720p, dan akan miliki nama <b>Eru</b>"
